 ...
 */
final class Version20260612092311 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL, isbn VARCHAR(13) DEFAULT NULL, summary CLOB DEFAULT NULL, publication_date DATE DEFAULT NULL, available BOOLEAN NOT NULL, language VARCHAR(10) DEFAULT NULL, cover_url VARCHAR(255) DEFAULT NULL, added_by_id INTEGER DEFAULT NULL, CONSTRAINT FK_CBE5A33155B127A4 FOREIGN KEY (added_by_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
